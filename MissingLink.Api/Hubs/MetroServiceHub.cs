...
public class MetroServiceHub : Hub
{
  private readonly List<string> connectionIds = new List<string>();
  private readonly IHubContext<MetroServiceHub> _hubContext;
  private readonly ILogger<MetroServiceHub> _logger;
  private readonly IServiceScopeFactory _serviceScopeFactory;
  public MetroServiceHub(IHubContext<MetroServiceHub> hubContext, ILogger<MetroServiceHub> logger,
